...
def readPicture(sourcePath,objectPath,*suffix):
    '''
    图片标准化与存储
    '''
    ...
    try:
        resultArray=read(sourcePath,*suffix)
        count=1
...
if __name__ == '__main__':
    print('Reading')
    readPicture('data/0/','dataset/0/','.jpg','.JPG','png','PNG','tiff')
    readPicture('data/1/','dataset/1/','.jpg','.JPG','png','PNG','tiff')
